...
def build_world():
  ...
  rooms['secret_room'] = Room(3,"Secret Room","You've found it! The secret room! You feel a sense of accomplishment... There is nothing left to do now. **Please use the command 'quit' to end the game now.**")
  ...
  rooms['hallway'].objects = [
    ...
    Object("Painting 3","Painting 3 shows a solumn-looking woman in a white cloth hat and wearing a golden cross.",aliases=['painting3','paintings3','painting three']),
  ...
  rooms['hallway'].custom_commands["turn painting 3"] = rotate_painting
